 ...
 *                             — B25-5 诚实边界: the dyld filter and sandbox
 *                             spoof are NOT yet implemented in the
 *                             systemhook interposer; FULL currently behaves
 *                             as LITE)
 *   AEGIS_LEVEL_PARANOID = 3 (full + mount enumeration hide via getfsstat;
 *                             credential scrub is intentionally owned by
 *                             cloak system-wide, not duplicated here)
 */
