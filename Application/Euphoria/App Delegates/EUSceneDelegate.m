...
@interface EUSceneDelegate ()

@end

@implementation EUSceneDelegate

- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    UIWindow *window = [[UIWindow alloc] initWithWindowScene:(UIWindowScene *)scene];
    window.rootViewController = [[EUNavigationController alloc] init];
...
+ (void)relaunch
{
    ...
    EUSceneDelegate *instance = (EUSceneDelegate *)windowScene.delegate;
