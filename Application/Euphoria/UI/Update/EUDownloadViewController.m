...
@interface EUDownloadViewController ()

@property (strong, nonatomic) EUUpdateCircleView *circleView;
...
@implementation EUDownloadViewController
...
- (void)viewDidLoad {
    ...
    self.titleLabel.text = EULocalizedString(@"Update_Status_Downloading");
    ...
    self.descriptionLabel.text = EULocalizedString(@"Update_Status_Subtitle_Please_Wait");
    ...
    self.circleView = [[EUUpdateCircleView alloc] initWithFrame:CGRectNull];
...
- (void)startBlinking {
    self.titleLabel.text = EULocalizedString(@"Update_Status_Installing");
    self.descriptionLabel.text = EULocalizedString(@"Update_Status_Subtitle_Restart_Soon");
