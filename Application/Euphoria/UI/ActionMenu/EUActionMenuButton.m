...
@implementation EUActionMenuButton 

+(EUActionMenuButton*)buttonWithAction:(UIAction *)action chevron:(BOOL)chevron
{
    EUActionMenuButton *button = [EUActionMenuButton buttonWithConfiguration:[EUGlobalAppearance defaultButtonConfiguration] primaryAction:action];
    [button.titleLabel setAdjustsFontSizeToFitWidth:YES];
    [button setContentHorizontalAlignment:UIControlContentHorizontalAlignmentLeft];

    if ([EUGlobalAppearance isRTL])
