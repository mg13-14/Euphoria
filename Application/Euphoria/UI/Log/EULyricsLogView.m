...
@implementation EULyricsLogView
...
- (id)init
{
    if (self = [super init]) {
        ...
        [NSLayoutConstraint activateConstraints:@[
            [self.stackView.topAnchor constraintEqualToAnchor:self.bottomAnchor constant:[EUGlobalAppearance isHomeButtonDevice] ? -50 : -80],
        ...
        EUProgressiveBlurView *blurView = [[EUProgressiveBlurView alloc] initWithGradientMask:[UIImage imageNamed:@"alpha-gradient"] maxBlurRadius:4];
...
- (void)showLog:(nonnull NSString *)log
{
    ...
    EULyricsLogItemView *itemView = [[EULyricsLogItemView alloc] initWithString:log completedImage:_checkmarkImage failedImage:_exclamationMarkImage successImage:_unlockedImage];
...
- (void)updateLog:(nonnull NSString *)log
{
    ...
    EULyricsLogItemView *lastItemView = self.stackView.arrangedSubviews.lastObject;
