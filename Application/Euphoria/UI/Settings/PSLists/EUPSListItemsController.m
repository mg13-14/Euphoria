...
@interface EUPSListItemsController ()

@end

@implementation EUPSListItemsController
...
- (void)viewDidLoad {
    ...
    _table.tableHeaderView = [EUPSListItemsController makeHeader: ((PSSpecifier*)self.specifier).name withTarget:self];
}
