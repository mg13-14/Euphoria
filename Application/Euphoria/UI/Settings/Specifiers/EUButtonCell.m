...
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(PSSpecifier *)specifier
{
    ...
    if (self)
    {
        UIAction *action = [UIAction actionWithTitle:EULocalizedString([specifier propertyForKey:@"title"]) image:[UIImage systemImageNamed:[specifier propertyForKey:@"image"] withConfiguration:[EUGlobalAppearance smallIconImageConfiguration]] identifier:[specifier propertyForKey:@"key"] handler:^(__kindof UIAction * _Nonnull action) {
        ...
        EUActionMenuButton *button = [EUActionMenuButton buttonWithAction:action chevron:NO];
