...
#import "EUCreditsCell.h"
#import "EUGlobalAppearance.h"

#define CREDITS_CELL_HEIGHT 35

@interface EUCreditsCellItem : UICollectionViewCell
@property (nonatomic, strong) UILabel *label;
@property (nonatomic, strong) NSURL *url;
@end

@implementation EUCreditsCellItem
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        [NSLayoutConstraint activateConstraints:@[
            [self.label.centerXAnchor constraintEqualToAnchor:self.contentView.centerXAnchor constant:-17 * ([EUGlobalAppearance isRTL] ? -1 : 1)],
...
- (id)initWithSpecifier:(PSSpecifier*)specifier
{
    if (self = [super init])
    {
        ...
        [self.collectionView registerClass:[EUCreditsCellItem class] forCellWithReuseIdentifier:@"item"];
...
{
    EUCreditsCellItem *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"item" forIndexPath:indexPath];
